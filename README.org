...
| *authorname*        | Author name (/ex. Zygmut/). If your document has more than one author this variable should include your names, as it's used for the header (or not, you could just redefine your fancy header). Remember to change the titlepage (if you use it) to show multiple authors
